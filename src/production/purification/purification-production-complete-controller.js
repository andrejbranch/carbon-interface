angular.module('production.purification.purificationProductionCompleteCtrl', [])

    .controller('purificationProductionCompleteCtrl', ['$scope', 'purificationRequest', '$cbResource', 'sampleGridFactory', 'API', 'purificationSampleType', '$localStorage', 'sampleImportManager', 'StepsService',
        ...
        function ($scope, purificationRequest, $cbResource, sampleGridFactory, API, purificationSampleType, $localStorage, sampleImportManager, StepsService) {
            ...
            $scope.purificationRequest = purificationRequest;
            ...
            $scope.download = function () {
                ...
                $cbResource.get('/production/purification-request/' + $scope.purificationRequest.id + '/download-output-template/' + $scope.totalSamples).then(function (response) {
                    ...
                    var filename = 'Protein Request ' + $scope.purificationRequest.id + ' Template.csv';
            ...
            $scope.import = function () {
                ...
                angular.forEach($scope.importGrid.data, function (sample) {
                    ...
                    sample.lot = $scope.purificationRequest.alias;
                ...
                $cbResource.create('/storage/sample-import/save', bulkSamples).then(function (response) {
                    ...
                    $cbResource.create('/production/purification-request/' + $scope.purificationRequest.id + '/complete', $scope.sampleIds).then(function (response) {
