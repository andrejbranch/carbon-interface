angular.module('production.affinityPurification.affinityPurificationProductionCompleteCtrl', [])

    .controller('affinityPurificationProductionCompleteCtrl', ['$scope', 'purificationRequest', '$cbResource', 'sampleGridFactory', 'API', 'purificationSampleType', '$localStorage', 'sampleImportManager', 'StepsService',
        ...
        function ($scope, purificationRequest, $cbResource, sampleGridFactory, API, purificationSampleType, $localStorage, sampleImportManager, StepsService) {
            ...
            $scope.affinityPurificationRequest = purificationRequest;
            ...
            $scope.download = function () {
                ...
                $cbResource.get('/production/purification-request/' + $scope.affinityPurificationRequest.id + '/download-output-template/' + $scope.totalSamples).then(function (response) {
                    ...
                    var filename = 'Purification Request ' + $scope.affinityPurificationRequest.id + ' Template.csv';
            ...
            $scope.import = function () {
                ...
                angular.forEach($scope.importGrid.data, function (sample) {
                    ...
                    sample.lot = $scope.affinityPurificationRequest.alias;
                ...
                $cbResource.create('/storage/sample-import/save', bulkSamples).then(function (response) {
                    ...
                    $cbResource.create('/production/purification-request/' + $scope.affinityPurificationRequest.id + '/complete', $scope.sampleIds).then(function (response) {
